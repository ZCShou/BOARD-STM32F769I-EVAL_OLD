...
#define CONFIG_SYS_LOAD_ADDR			0x08010000
#else
...
#define CONFIG_SYS_SPL_LEN				0x00010000
/* 自定义 U-Boot 的入口点。对于 ARM，入口点就是 Image 的开头（复位中断）。不定义该宏值，默认采用 CONFIG_SYS_TEXT_BASE 作为入口点 */
// #define CONFIG_SYS_UBOOT_START		0x080083FD
/* 定义 U-boot 在片内 FLASH 的基地址 */
#define CONFIG_SYS_UBOOT_BASE			(CONFIG_SYS_FLASH_BASE + CONFIG_SYS_SPL_LEN)

/* DT blob (fdt) address. 在 Falcon 模式下使用 */
